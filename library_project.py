class Library(object):
    ...
    def lendBook(self,user,book):
        if book not in self.lendDict.keys():
            ...
            print(f"Book is already bieng used by {self.lendDict[book]}")
...
if __name__ =='__main__':
    collection = Library(['Python Cookbook','Django for Beginners','Introduction to C++','Machine Learning and AI'],"Symboisis Library")
    while(True):
        print(f"Welcome to the {collection.name} Library. Enter your choice to continue")
